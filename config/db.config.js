...
export const pool = mysql.createPool({
    host: process.env.DB_HOST || 'yenningdb.cl7spct0zz5t.ap-northeast-2.rds.amazonaws.com', // mysql의 hostname
    user: process.env.DB_USER || 'root', // user 이름
    port: process.env.DB_PORT || 3306, // 포트 번호
    database: process.env.DB_TABLE || 'UMC5th_MVP', // 데이터베이스 이름
    password: process.env.DB_PASSWORD || 'yaeyoon1004!', // 비밀번호
